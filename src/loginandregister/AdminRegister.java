...
public class AdminRegister extends JFrame{
    ...
    public AdminRegister() {
        account = new CreateAccount().account;
        //设置背景
    ...
    private class MyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == btn) {
                if(passwordFiled1.getText().matches("[0-9]{6}")&&passwordFiled2.getText().matches("[0-9]{6}")) {
                    if (passwordFiled1.getText().equals(passwordFiled2.getText()) && passwordFiled2.getText().length() == 6) {
                        ...
                        JOptionPane.showMessageDialog(null, "密码和确认密码不一致，注册失败,请修改！", "标题", JOptionPane.WARNING_MESSAGE);
                    }
                }else{
